...
try {
    ...
    //Remetente
    $mail->setFrom('XXXXX@XXXXXXXX', 'Seu Nome');
    
    //Destinatário
    $mail->addAddress('XXXXX@XXXXXXXX', 'Nome do Destinatário');
